...
if(isset($_POST['id_add_abo']) && !empty($_POST['id_add_abo']) && isset($_POST['btn_add_abo']))
{
...
<div class="container body-complete" style="<?php if(isset($_GET['id'])){
	...
	<div class="left">
		<div class="bloc wall-menu">
			<ul>
				<li><a href="index.php?page=profil&amp;id=<?php echo $_GET['id']; ?>">Swiffs<span class="menu-chev"><i class="icon-chevron-right"></i></span></a></li>
...
{
?>
				<li><a href="<?php echo str_replace('&', '&amp;',$_SERVER['REQUEST_URI']) . "&amp;bloc=msg"; ?>" class="btn"><i class="icon-envelope"></i></a></li>
