...
?>
						<div id="<?php echo $id_msg; ?>ans" class="answer" onclick="tweet_rep('<?php echo $id_msg; ?>')">
							...
							<br>
							<p><?php echo nl2br2(checkTags($bdd, html_entity_decode($reply['content']), $reply['id_user'])); ?></p><br><a href="<?php echo $reply['image']; ?>" target="_blank"><?php echo $reply['image']; ?></a></p>
						</div>
<?php
}
if(isset($value['id_retweet']) && $value['id_retweet'] !=  NULL)
...
?>
						<div id="<?php echo $id_msg; ?>" onclick="tweet_rep('<?php echo $id_msg; ?>')">
							...
							<br>
							<p><?php echo nl2br2(checkTags($bdd, html_entity_decode($retweet['content']), $retweet['id_user'])); ?></p><br><a href="<?php echo $retweet['image']; ?>" target="_blank"><?php echo $retweet['image']; ?></a></p>
						</div>
<?php
...
?>
						<div id="<?php echo $id_msg; ?>" onclick="tweet_rep('<?php echo $id_msg; ?>')">
							...
							<span class="date-tweet"><?php echo date("j F y", date_timestamp_get(date_create($value['date']))); ?></span>
							<br>
							<p><?php echo nl2br2(checkTags($bdd, html_entity_decode($value['content']), $value['id_user'])); ?></p><br><a href="<?php echo $value['image']; ?>" target="_blank"><?php echo $value['image']; ?></a></p>
						</div>
<?php
